"""
Crea un script que:
Pida al usuario por teclado su nombre, edad y altura (usa input() para capturar los datos).
Convierte la edad a int y la altura a float.
Muestra un mensaje en pantalla como:
